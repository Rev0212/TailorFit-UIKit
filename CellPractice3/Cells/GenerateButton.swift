...
//}
//
//// Setup function in the view controller
//import UIKit
//
//class GenerateButton: UIButton {
//    override init(frame: CGRect) {
...
//        let swiftUIButtonView = SwiftUIButtonWrapper {
//            print("SwiftUI Button Tapped!")
//        }
//        
//        swiftUIButtonView.translatesAutoresizingMaskIntoConstraints = false
//        addSubview(swiftUIButtonView)
//
//        NSLayoutConstraint.activate([
//            swiftUIButtonView.topAnchor.constraint(equalTo: topAnchor),
//            swiftUIButtonView.bottomAnchor.constraint(equalTo: bottomAnchor),
//            swiftUIButtonView.leadingAnchor.constraint(equalTo: leadingAnchor),
//            swiftUIButtonView.trailingAnchor.constraint(equalTo: trailingAnchor)
//        ])
//    }
//}
import UIKit
...
class GenerateButton: UIButton {
    ...
    private func setupSwiftUIButton() {
        let swiftUIButtonView = SwiftUIButtonWrapper(button: self) {
            print("SwiftUI Button Tapped!")
        }
